...
class Reservacion {
    ...
    /**
     * Crear nueva reservación con validación en tiempo real
     */
    ...
    /**
     * Verificar disponibilidad de mesa en tiempo real
     */
    ...
    /**
     * Obtener mesas disponibles con validación en tiempo real
     */
    public function obtenerMesas($fecha = null, $hora = null, $personas = null) {
        try {
            ...
            // Agregar información de disponibilidad para cada mesa
            $resultado = [];
    ...
    public function actualizar($id, $datos) {
        try {
            // Si se cambia la mesa, fecha u hora, verificar disponibilidad
            if (isset($datos['id_mesa']) && isset($datos['fecha']) && isset($datos['hora'])) {
                // Excluir la reservación actual de la verificación
                $sql = "SELECT COUNT(*) as total
                        FROM {$this->table}
                        WHERE ID_MESA = ?
                          AND FECHA = ?
    ...
    /**
     * Obtener reservaciones del día actual
     */
